...
from ultralytics.nn.attention.GAM import GAM_Attention
from ultralytics.nn.attention.SK import SKAttention
...
class BaseModel(nn.Module):
    ...
    def _apply(self, fn):
        ...
        if isinstance(m, (Detect, Detect_LDEH)):  # includes all Detect subclasses like Segment, Pose, OBB, WorldDetect
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in {
        ...
        elif m in {Detect, WorldDetect, Segment, Pose, OBB, ImagePoolingAttn, v10Detect, Detect_LDEH}:
            ...
            c2 = ch[f[-1]]
        elif m in {GAM_Attention, SKAttention}:  # TODO
            args = [ch[f], *args]
        else:
            c2 = ch[f]
