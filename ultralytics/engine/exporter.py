...
from ultralytics.nn.modules import C2f, Detect, RTDETRDecoder, Detect_LDEH
...
class Exporter:
    ...
    def __call__(self, model=None) -> str:
        ...
        for m in model.modules():
            if isinstance(m, (Detect, RTDETRDecoder, Detect_LDEH)):  # includes all Detect subclasses like Segment, Pose, OBB
