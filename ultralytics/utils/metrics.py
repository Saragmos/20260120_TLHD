...
class WiseIouLoss(torch.nn.Module):
    ...
    def __init__(self, ltype='WIoU', monotonous=False, inner_iou=False, focaler_iou=False): # False
        super().__init__()
    ...
    def forward(self, pred, target, ret_iou=False, ratio=1.0, d=0.0, u=0.95, **kwargs):
        self._fget = {
            ...
            # IoU / Inner-IoU
            'iou': lambda: (1 - get_inner_iou(pred, target, xywh=False, ratio=ratio).squeeze()) if self.inner_iou else 1 - self['s_inter'] / self['s_union'],
        }
